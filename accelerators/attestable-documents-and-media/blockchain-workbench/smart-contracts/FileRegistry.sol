...
contract File {
	...
	constructor (string registryAddress, string fileId, string location, string fileHash, string fileMetadataHash, string contentType, string etag, string processedDateTime) public {
		FileId = fileId;
		Location = location;
		FileHash = fileHash;
