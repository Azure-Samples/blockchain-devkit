 ...
 *
 */
class IngressReceiveMessageProcessor(val registry: Registry, val msg: ServiceBusReceivedMessage, val returnQueue: ServiceBusSenderClient) : Runnable {

    companion object {
        private val logger: Logger = LoggerFactory.getLogger(IngressReceiveMessageProcessor::class.java)
    }
    ...
    private fun process(msg: ServiceBusReceivedMessage) {
    ...
    private fun extractMessageData(msg: ServiceBusReceivedMessage): MessageData {
