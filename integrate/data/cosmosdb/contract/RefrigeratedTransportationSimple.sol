...
contract RefrigeratedTransportationSimple
{
    //Set of States
    enum StateType { Created, InTransit, Completed, OutOfCompliance}
    enum SensorType { None, Temperature }
    ...
    constructor(address device, address supplyChainOwner, address supplyChainObserver, int minTemperature, int maxTemperature) public
    {
    ...
    function IngestTelemetry(int temperature, int timestamp) public
    {
