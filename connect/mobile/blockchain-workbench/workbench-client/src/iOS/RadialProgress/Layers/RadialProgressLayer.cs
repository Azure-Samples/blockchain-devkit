...
namespace RadialProgress
{
	internal abstract class RadialProgressLayer : CALayer
	{
		...
		public static readonly UIColor DefaultFillColor = UIColor.FromRGB(116, 49, 117);
        public static readonly CGColor DefaultBackgroundColor = UIColor.FromRGB(193, 149, 194).CGColor;
        ...
        public static CGColor BackCircleBackgroundColor = DefaultBackgroundColor;
