...
namespace RadialProgress
{
	public class RadialProgressView : View
	{
		...
		const float textFontSizePercentage = 0.18f;
		...
		public static readonly Color DefaultColor = Color.Rgb(116, 49, 117);
        public static readonly Color DefaultCircleBackgroundColor = Color.Rgb(193, 149, 194);

        public static Color CircleBackgroundColor = DefaultCircleBackgroundColor;
